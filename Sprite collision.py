...
#constans for easier adjustments
...
background_image=pygame.transform.scale(pygame.image.load("img.jpg"),
                                        SCREEN_WIDTH,SCREEN_HEIGHT)

#load font once at the begining
font=pygame.font.SysFont("Times New Roman",FONT_SIZE)

class Sprites(pygame.sprites.Sprite):
    def __init__(self,color,height,width):
        super().__init__()
        self.image=pygame.Surface([width,height])
        self.image.fill(pygame.Color('dodgerblue')) #background color of image
